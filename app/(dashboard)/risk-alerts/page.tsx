              ...
              <CardContent className="p-0">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 p-8 relative z-10">
                  ...
                  <div className="flex items-center gap-3">
                    <button className="px-6 py-3 bg-rose-500 text-white rounded-[1.25rem] text-sm font-bold shadow-xl shadow-rose-500/20 hover:bg-rose-600 hover:translate-y-[-2px] transition-all flex items-center gap-2">
                       Take Action
